...
})({"jkLYw":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "83f3ddaf48d63798";
"use strict";
...
},{}],"aTSpq":[function(require,module,exports) {
...
signupForm.addEventListener("submit", async (e)=>{
    try {
        ...
        let res = await fetch(`${(0, _configJs.API_URL)}/signup`, {
            method: "POST",
            body: JSON.stringify({
...
loginForm.addEventListener("submit", async (e)=>{
    try {
        ...
        let res = await fetch(`${(0, _configJs.API_URL)}/login`, {
            method: "POST",
            body: JSON.stringify({
                email: emailInput.value,
                password: passwordInput.value
...
},{}]},["jkLYw","aTSpq"], "aTSpq", "parcelRequiree5c7")

//# sourceMappingURL=index.48d63798.js.map
