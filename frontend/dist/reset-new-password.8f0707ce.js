...
module.bundle.HMR_BUNDLE_ID = "4c437bb68f0707ce";
"use strict";
...
},{}],"fT3VU":[function(require,module,exports) {
...
resetnewPassForm.onsubmit = async (e)=>{
    try {
        ...
        const verifCode = JSON.parse(localStorage.getItem("todo-app-reset-verifcode"));
        if (!email || !verifCode) return toFormLink.click();
        let res = await fetch(`${(0, _configJs.API_URL)}/newPassword`, {
            method: "POST",
            body: JSON.stringify({
                email: email,
                verifCode: verifCode,
...
},{}]},["kqaxJ","fT3VU"], "fT3VU", "parcelRequiree5c7")

//# sourceMappingURL=reset-new-password.8f0707ce.js.map
