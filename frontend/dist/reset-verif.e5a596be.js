...
})({"1U5ND":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "8481ddd8e5a596be";
"use strict";
...
},{}],"2TO3p":[function(require,module,exports) {
...
resetVerifCodeForm.addEventListener("submit", async (e)=>{
    try {
        ...
        if (!email) return toFormLink.click();
        let res = await fetch(`${(0, _configJs.API_URL)}/verifcode`, {
            method: "POST",
            body: JSON.stringify({
        ...
        localStorage.setItem("todo-app-reset-verifcode", JSON.stringify(verifCodeInput.value));
...
},{}]},["1U5ND","2TO3p"], "2TO3p", "parcelRequiree5c7")

//# sourceMappingURL=reset-verif.e5a596be.js.map
